          ...
          <div className="relative w-40 h-40 rounded-full chart_loader">
            <div className="absolute inset-7 bg-white rounded-full flex items-center justify-center">
              <div className="text-center flex justify-center items-center flex-col gap-2">
                <p className="bg-slate-400 h-6 rounded-sm w-16"></p>
                <p className="bg-slate-400 h-6 rounded-sm w-10"></p>
              </div>
            </div>
          </div>
        </div>
          ...
          {new Array(5).fill(0).map(( _ ,index) => (
            <React.Fragment key={index}>
              <div className="flex items-center space-x-2">
                <div className="bg-slate-400 w-5 h-5 rounded-sm"></div>
                <span className="bg-slate-400 h-5 rounded-sm w-20"></span>
              </div>
            </React.Fragment>
          ))}
        </div>
