...
const HeroSection: React.FC = () => {
  ...
  return (
    <motion.div
      ...
      initial="initial"
      animate="animate"
      className="hero_section_container relative mx-auto flex h-full w-full max-w-5xl 2xl:max-w-7xl flex-col items-center justify-between px-4 sm:flex-row py-5 pb-10 xl:pb-5"
    >
      <div className="hero_section_content flex w-full max-w-full flex-col justify-center gap-2 xl:gap-5 2xl:gap-8">
        <motion.h1
          ...
          initial="initial"
          animate="animate"
          className="hero_section_title text-2xl tracking-wide sm:text-3xl lg:text-4xl 2xl:text-5xl font-bree"
        >
        ...
        >
          Built for students to track spending, manage pocket money,
          and
